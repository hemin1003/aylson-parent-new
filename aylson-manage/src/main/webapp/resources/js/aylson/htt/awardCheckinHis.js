	...
	$(function() { 
		datagrid = $('#datagrid').datagrid({
			method:'get',
			url : projectName+'/htt/httAwardCheckinHis/admin/list?v_date=' + new Date(),
			pagination : true,
			pageSize : 20,
	...
	//搜索
	function doSearch(){
		$("#datagrid").datagrid("load", serializeObject($("#awardCheckinHisForm")));
	}
	
	//重置
	function reset(){
		$("#awardCheckinHisForm").form("reset");
	}
