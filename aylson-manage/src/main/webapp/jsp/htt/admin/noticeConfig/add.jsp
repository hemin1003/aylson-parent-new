		 	...
		 	<form id="httNoticeConfigForm" method="post">
				<table class="tableForm" style="width:99%;">
					...
					<tr>
						<th>标签：</th>
						<td colspan="3" style="text-align:left">
							<input name="tag" value="${noticeConfigVo.tag}" data-options="required:false"
								class="easyui-textbox"
								style="width:95%; text-align:left"/>
						</td>
					</tr>
					...
					<tr>
						<th>标题图：</th>
						<td colspan="3" style="text-align:left">
							<input name="titleMapUrl" value="${noticeConfigVo.titleMapUrl}" data-options="required:false"
								class="easyui-textbox"
								style="width:95%; text-align:left"/>
						</td>
					</tr>
