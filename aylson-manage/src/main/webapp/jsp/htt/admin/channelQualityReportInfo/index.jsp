...
<body class="easyui-layout" fit="true">
	<div region="north" style="white-space: nowrap;padding: 5px; height: 50px;">
		<div style="margin-bottom: 5px">
			<form id="channelQualityReportInfoForm"  method="post">
				<table class="table_content"   border="0" >
					<tr>
					
					    <td class="tar" >注册日期：</td>
						<td class="tal" >
...
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/aylson/htt/channelQualityReportInfo.js?date=2016112516"></script>
</html>