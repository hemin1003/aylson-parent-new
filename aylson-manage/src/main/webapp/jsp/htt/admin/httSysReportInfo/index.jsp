...
<body class="easyui-layout" fit="true">
	<div region="north" style="white-space: nowrap;padding: 5px; height: 100px;">
		<div style="margin-bottom: 5px">
			<form id="httSysReportInfoForm"  method="post">
...
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/aylson/htt/sysReportInfo.js?date=2016112516"></script>
 <script type="text/javascript">
      ...
      function getMapData(num){
    	  	  myChart.showLoading();
       	  // 异步加载数据
          $.get(projectName+'/htt/httSysReportInfo/admin/listMap?num=' + num).done(function (data) {
          		myChart.hideLoading();
      ...
      // 异步加载数据
      $.get(projectName+'/htt/httSysReportInfo/admin/listTop').done(function (data) {
      		var dataObj = jQuery.parseJSON(data);
