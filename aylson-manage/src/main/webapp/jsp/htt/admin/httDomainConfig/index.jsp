...
<body class="easyui-layout" fit="true">
	<div region="north" style="white-space: nowrap;padding: 5px; height: 50px;">
		<div style="margin-bottom: 5px">
			<form id="httDomainConfigForm"  method="post">
				<table class="table_content"   border="0" >
					<tr>
						<td class="tar" >域名用途：</td>
						<td class="tal" >
							<select id="flag" name="flag" class="easyui-combobox" style="width: 120px;" editable=false>
								<option value="">全部</option>
								<option value="1">电信天翼</option>
								<option value="2">大咖用途</option>
							</select>
						</td>
...
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/aylson/htt/httDomainConfig.js?date=2016112516"></script>
</html>