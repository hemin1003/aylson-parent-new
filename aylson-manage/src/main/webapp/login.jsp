  ...
  <body>
    ...
    <div class="container">
		...
		<form class="form-signin" id="login_form" method="post" autocomplete="off">
           ...
           <input  id="userName" name="userName" value="superadmin"  prompt="用户名" placeholder="输入可搜索" pattern="输入可搜索"  class="easyui-textbox"  style="width: 300px;height:40px;padding:8px 9px;font-size:16px;"/><br/>
		...
		<div align="center">版权所有 @ 2017.XXXXXX有限公司.</div>
    </div>
