...
import com.aylson.dc.htt.vo.HttInitConfigVo;
 ...
 */
@Controller
@RequestMapping("/htt/initConfig")
public class HttInitConfigController extends BaseController {
	
	protected static final Logger logger = Logger.getLogger(HttInitConfigController.class);

	@Autowired
	private HttInitConfigService initConfigService;
	...
	public String toIndex() {
		return "/jsp/htt/admin/initConfig/index";
	}
	...
	@ResponseBody
	public EasyuiDataGridJson list(HttInitConfigSearch initConfigSearch){
		EasyuiDataGridJson result = new EasyuiDataGridJson();//页面DataGrid结果集
		try{
			initConfigSearch.setIsPage(true);
			List<HttInitConfigVo> list = this.initConfigService.getList(initConfigSearch);
	...
	public String toAdd(HttInitConfigVo initConfigVo) {
		this.request.setAttribute("initConfigVo", initConfigVo);
		return "/jsp/htt/admin/initConfig/add";
	}
	...
	@ResponseBody
	public Result add(HttInitConfigVo initConfigVo) {
	...
	public String toEdit(String id) {
		if(id != null){
			HttInitConfigVo initConfigVo = this.initConfigService.getById(id);
			this.request.setAttribute("initConfigVo", initConfigVo);
		}
		return "/jsp/htt/admin/initConfig/add";
	}
	...
	@ResponseBody
	public Result update(HttInitConfigVo initConfigVo) {
		Result result = new Result();
		try {
			SessionInfo sessionInfo = (SessionInfo)this.request.getSession().getAttribute("sessionInfo");
