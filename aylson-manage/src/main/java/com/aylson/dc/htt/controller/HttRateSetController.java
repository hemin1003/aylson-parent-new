...
import com.aylson.dc.htt.vo.HttRateSetVo;
 ...
 */
@Controller
@RequestMapping("/htt/rateSet")
public class HttRateSetController extends BaseController {
	
	protected static final Logger logger = Logger.getLogger(HttRateSetController.class);

	@Autowired
	private HttRateSetService rateSetService;
	...
	public String toIndex() {
		return "/jsp/htt/admin/rateSet/index";
	}
	...
	@ResponseBody
	public EasyuiDataGridJson list(HttRateSetSearch rateSetSearch){
		EasyuiDataGridJson result = new EasyuiDataGridJson();//页面DataGrid结果集
		try{
			rateSetSearch.setIsPage(true);
			List<HttRateSetVo> list = this.rateSetService.getList(rateSetSearch);
	...
	public String toAdd(HttRateSetVo rateSetVo) {
		this.request.setAttribute("rateSetVo", rateSetVo);
		return "/jsp/htt/admin/rateSet/add";
	}
	...
	@ResponseBody
	public Result add(HttRateSetVo rateSetVo) {
	...
	public String toEdit(String id) {
		if(id != null){
			HttRateSetVo rateSetVo = this.rateSetService.getById(id);
			this.request.setAttribute("rateSetVo", rateSetVo);
		}
		return "/jsp/htt/admin/rateSet/add";
	}
	...
	@ResponseBody
	public Result update(HttRateSetVo rateSetVo) {
		Result result = new Result();
		try {
			SessionInfo sessionInfo = (SessionInfo)this.request.getSession().getAttribute("sessionInfo");
	...
	@ResponseBody
	public Result changeStatus(HttRateSetVo rateSetVo) {
		Result result = new Result();
		try {
