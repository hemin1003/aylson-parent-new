...
import com.aylson.dc.htt.vo.HttAdvListVo;
 ...
 */
@Controller
@RequestMapping("/htt/advList")
public class HttAdvListController extends BaseController {
	
	protected static final Logger logger = Logger.getLogger(HttAdvListController.class);

	@Autowired
	private HttAdvListService advListService;
	...
	public String toIndex() {
		return "/jsp/htt/admin/advList/index";
	}
	...
	@ResponseBody
	public EasyuiDataGridJson list(HttAdvListSearch advListSearch){
		EasyuiDataGridJson result = new EasyuiDataGridJson();//页面DataGrid结果集
		try{
			advListSearch.setIsPage(true);
			List<HttAdvListVo> list = this.advListService.getList(advListSearch);
	...
	public String toAdd(HttAdvListVo advListVo) {
		this.request.setAttribute("advListVo", advListVo);
		return "/jsp/htt/admin/advList/add";
	}
	...
	@ResponseBody
	public Result add(HttAdvListVo advListVo) {
	...
	public String toEdit(String id) {
		if(id != null){
			HttAdvListVo advListVo = this.advListService.getById(id);
			this.request.setAttribute("advListVo", advListVo);
		}
		return "/jsp/htt/admin/advList/add";
	}
	...
	@ResponseBody
	public Result update(HttAdvListVo advListVo) {
		Result result = new Result();
		try {
			SessionInfo sessionInfo = (SessionInfo)this.request.getSession().getAttribute("sessionInfo");
	...
	@ResponseBody
	public Result changeStatus(HttAdvListVo advListVo) {
		Result result = new Result();
		try {
