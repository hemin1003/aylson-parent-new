...
import com.aylson.dc.htt.vo.HttAdvDetailVo;
 ...
 */
@Controller
@RequestMapping("/htt/advDetail")
public class HttAdvDetailController extends BaseController {
	
	protected static final Logger logger = Logger.getLogger(HttAdvDetailController.class);

	@Autowired
	private HttAdvDetailService advDetailService;
	...
	public String toIndex() {
		return "/jsp/htt/admin/advDetail/index";
	}
	...
	@ResponseBody
	public EasyuiDataGridJson list(HttAdvDetailSearch advDetailSearch){
		EasyuiDataGridJson result = new EasyuiDataGridJson();//页面DataGrid结果集
		try{
			advDetailSearch.setIsPage(true);
			List<HttAdvDetailVo> list = this.advDetailService.getList(advDetailSearch);
	...
	public String toAdd(HttAdvDetailVo advDetailVo) {
		this.request.setAttribute("advDetailVo", advDetailVo);
		return "/jsp/htt/admin/advDetail/add";
	}
	...
	@ResponseBody
	public Result add(HttAdvDetailVo advDetailVo) {
	...
	public String toEdit(String id) {
		if(id != null){
			HttAdvDetailVo advDetailVo = this.advDetailService.getById(id);
			this.request.setAttribute("advDetailVo", advDetailVo);
		}
		return "/jsp/htt/admin/advDetail/add";
	}
	...
	@ResponseBody
	public Result update(HttAdvDetailVo advDetailVo) {
		Result result = new Result();
		try {
			SessionInfo sessionInfo = (SessionInfo)this.request.getSession().getAttribute("sessionInfo");
	...
	@ResponseBody
	public Result changeStatus(HttAdvDetailVo advDetailVo) {
		Result result = new Result();
		try {
