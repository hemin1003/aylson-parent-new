...
import com.aylson.dc.htt.vo.HttTimeHisVo;
 ...
 */
@Controller
@RequestMapping("/htt/httTimeHis")
public class HttTimeHisController extends BaseController {
	
	protected static final Logger logger = Logger.getLogger(HttTimeHisController.class);

	@Autowired
	private HttTimeHisService timeHisService;
	...
	public String toIndex() {
		return "/jsp/htt/admin/timeHis/index";
	}
	...
	@ResponseBody
	public EasyuiDataGridJson list(HttTimeHisSearch timeHisSearch){
		EasyuiDataGridJson result = new EasyuiDataGridJson();//页面DataGrid结果集
		try{
			timeHisSearch.setIsPage(true);
			List<HttTimeHisVo> list = this.timeHisService.getList(timeHisSearch);
			result.setTotal(this.timeHisService.getRowCount(timeHisSearch));
			result.setRows(list);
			return result;
		}catch(Exception e){
