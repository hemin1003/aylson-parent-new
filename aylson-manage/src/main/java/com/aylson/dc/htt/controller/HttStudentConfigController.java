...
import com.aylson.dc.htt.vo.HttStudentConfigVo;
 ...
 */
@Controller
@RequestMapping("/htt/studentConfig")
public class HttStudentConfigController extends BaseController {
	
	protected static final Logger logger = Logger.getLogger(HttStudentConfigController.class);

	@Autowired
	private HttStudentConfigService studentConfigService;
	...
	public String toIndex() {
		return "/jsp/htt/admin/studentConfig/index";
	}
	...
	@ResponseBody
	public EasyuiDataGridJson list(HttStudentConfigSearch studentConfigSearch){
		EasyuiDataGridJson result = new EasyuiDataGridJson();//页面DataGrid结果集
		try{
			studentConfigSearch.setIsPage(true);
			List<HttStudentConfigVo> list = this.studentConfigService.getList(studentConfigSearch);
	...
	public String toAdd(HttStudentConfigVo studentConfigVo) {
		this.request.setAttribute("studentConfigVo", studentConfigVo);
		return "/jsp/htt/admin/studentConfig/add";
	}
	...
	@ResponseBody
	public Result add(HttStudentConfigVo studentConfigVo) {
	...
	public String toEdit(String id) {
		if(id != null){
			HttStudentConfigVo studentConfigVo = this.studentConfigService.getById(id);
			this.request.setAttribute("studentConfigVo", studentConfigVo);
		}
		return "/jsp/htt/admin/studentConfig/add";
	}
	...
	@ResponseBody
	public Result update(HttStudentConfigVo studentConfigVo) {
		Result result = new Result();
		try {
			SessionInfo sessionInfo = (SessionInfo)this.request.getSession().getAttribute("sessionInfo");
	...
	@ResponseBody
	public Result changeStatus(HttStudentConfigVo studentConfigVo) {
		Result result = new Result();
		try {
